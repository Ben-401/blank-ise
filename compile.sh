...
# find out where we are, we should be in the toplevel dir
BASEDIR=$(pwd)
# ise compile-script output dir
SCROUTDIR="scriptoutdir"
...
if test -e ${BASEDIR}/${TARGET}; then
  ...
  UCF_TARGET_FPGA="../../../ise147pn/mega65-nonddr/container-nonddr.ucf"
  TARGET_TAG="${TARGET}"
else
  ...
  UCF_TARGET_FPGA="../../../ise147pn/mega65-ddr/container-ddr.ucf"
  TARGET_TAG="ddr"
fi
